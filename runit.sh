...
docker run --name fherling-ocr --rm -v /Users/fherling/Documents/git/OCR/ocr-input:/ocr-input -v /Users/fherling/Documents/git/OCR/ocr-output:/ocr-output fherlingatpd/fherling-ocr:latest
